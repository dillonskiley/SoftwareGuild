...
Output: 
String to search in: xxaxxxbxx
Character to find: x
Number of times the character appears: 7
*/

/* Counting a Series of Characters in a String */

/* NOT WORKING - countingnumbers is undefined

    Refer to Counting a Specific Character in a String 
/*
Input:
countingCharacters3("xxaxxxbxx","xx");
Output:
String to search in: xxaxxxbxx
Characters to find: xx
Number of times the character appears: 4
:/
